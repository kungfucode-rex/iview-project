<template>
    <div>
        <Table stripe :context="self" :data="tableData1" :columns="tableColumns1"></Table>
    ...
    export default {
                    ...
                    {},
                    {
                        ...
                        render (row, column, index) {
                            return `<Poptip trigger="hover" title="${row.portrayal.length}个画像" placement="bottom">
                                        ...
                                        <div slot="content">
                                            <ul>
                                                <li v-for="item in tableData1[${index}].people"
        ...
        methods: {
            mockTableData1 () {
                ...
                for (let i = 0; i < 10; i++) {
                    data.push({
                        name: '商圈' + Math.floor(Math.random() * 100 + i),
                        ...
                        time: Math.floor(Math.random() * 7 + i),
                        update: new Date()
                    })
                }
                return data
